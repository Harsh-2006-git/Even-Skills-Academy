        ...
        <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-8 lg:gap-12 w-full">
          ...
          <div className="flex flex-col items-start gap-4 flex-1 pr-4">
            ...
            <p className="text-[#191919] font-inter text-sm sm:text-base md:text-lg font-medium leading-[1.3em] opacity-[90%] max-w-[550px]">
              Over <strong className="font-extrabold text-black"><Counter value={4400} />+ women</strong> trained across four modules all from resource-poor
          ...
          <div className="grid grid-cols-2 gap-2.5 sm:gap-3.5 w-full lg:w-[476px] shrink-0">
            <div className="flex p-2.5 justify-center items-center rounded-[12px] sm:rounded-[18px] bg-[rgba(253,253,253,0.74)] w-full h-[54px] sm:h-[68px] shadow-sm select-none">
              <p className="text-[#191919] font-inter text-[11px] sm:text-[14px] md:text-[15px] font-bold leading-tight text-center">
                <Counter value={4400} />+ Total Trained
              </p>
            </div>
            <div className="flex p-2.5 justify-center items-center rounded-[12px] sm:rounded-[18px] bg-[rgba(253,253,253,0.74)] w-full h-[54px] sm:h-[68px] shadow-sm select-none">
              <p className="text-[#191919] font-inter text-[11px] sm:text-[14px] md:text-[15px] font-bold leading-tight text-center">
                <Counter value={10} />+ Cities Active
              </p>
            </div>
            <div className="flex p-2.5 justify-center items-center rounded-[12px] sm:rounded-[18px] bg-[rgba(253,253,253,0.74)] w-full h-[54px] sm:h-[68px] shadow-sm select-none">
              <p className="text-[#191919] font-inter text-[11px] sm:text-[14px] md:text-[15px] font-bold leading-tight text-center">
                <Counter value={4} /> Training Modules
              </p>
            </div>
            <div className="flex p-2.5 justify-center items-center rounded-[12px] sm:rounded-[18px] bg-[rgba(253,253,253,0.74)] w-full h-[54px] sm:h-[68px] shadow-sm select-none">
              <p className="text-[#191919] font-inter text-[11px] sm:text-[14px] md:text-[15px] font-bold leading-tight text-center">
                <Counter value={72} />% Avg Placement
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 xl:gap-8 w-full">
          ...
          >
            ...
            <div className="flex justify-between items-center w-full">
              <div className="flex items-center justify-center rounded-xl bg-[#A64AED] w-[34px] h-[32px] sm:w-[42px] sm:h-[40px] shrink-0">
                <svg
                  viewBox="0 0 42 40"
                  fill="none"
                  xmlns="http://www.w3.org/2000/svg"
                  className="w-[28px] h-[26px] sm:w-[36px] sm:h-[34px]"
                >
                  <path
            ...
            <div className="flex flex-col items-start mt-1 sm:mt-2 w-full">
              ...
              <p className="text-[#191919] font-inter text-[18px] sm:text-2xl font-bold leading-7 mt-0.5">
                <Counter value={1200} /> women
              </p>
            </div>

            {/* Chart Area */}
            <div className="flex justify-between items-end gap-1 sm:gap-1.5 w-full h-[60px] sm:h-[88px] mt-auto px-1 select-none">
              <motion.div initial={{ scaleY: 0 }} whileInView={{ scaleY: 1 }} viewport={{ once: true }} transition={{ duration: 0.6, delay: 0.1, ease: "easeOut" }} style={{ originY: 1 }} className="rounded-t-[4px] opacity-[41%] bg-[#A64AED] w-[14%] h-5"></motion.div>
              <motion.div initial={{ scaleY: 0 }} whileInView={{ scaleY: 1 }} viewport={{ once: true }} transition={{ duration: 0.6, delay: 0.2, ease: "easeOut" }} style={{ originY: 1 }} className="rounded-t-[4px] opacity-[41%] bg-[#A64AED] w-[14%] h-[36px]"></motion.div>
              <motion.div initial={{ scaleY: 0 }} whileInView={{ scaleY: 1 }} viewport={{ once: true }} transition={{ duration: 0.6, delay: 0.3, ease: "easeOut" }} style={{ originY: 1 }} className="rounded-t-[4px] bg-[#A64AED] w-[14%] h-[68px]"></motion.div>
              <motion.div initial={{ scaleY: 0 }} whileInView={{ scaleY: 1 }} viewport={{ once: true }} transition={{ duration: 0.6, delay: 0.4, ease: "easeOut" }} style={{ originY: 1 }} className="rounded-t-[4px] opacity-[41%] bg-[#A64AED] w-[14%] h-[52px]"></motion.div>
              <motion.div initial={{ scaleY: 0 }} whileInView={{ scaleY: 1 }} viewport={{ once: true }} transition={{ duration: 0.6, delay: 0.5, ease: "easeOut" }} style={{ originY: 1 }} className="rounded-t-[4px] bg-[#A64AED] w-[14%] h-[88px]"></motion.div>
            </div>
          </motion.div>
          ...
          >
            {/* Top row */}
            <div className="flex justify-between items-center w-full">
              <div className="flex items-center justify-center rounded-xl bg-[#A64AED] w-[32px] h-[36px] sm:w-[40px] sm:h-[44px] shrink-0">
                <svg
                  viewBox="0 0 40 44"
                  fill="none"
                  xmlns="http://www.w3.org/2000/svg"
                  className="w-[26px] h-[28px] sm:w-[32px] sm:h-[36px]"
                >
                  <path
            ...
            <div className="relative flex flex-col justify-end w-full h-[80px] sm:h-[110px] mt-auto select-none">
              <motion.span 
                ...
                className="absolute right-[4%] top-[-18px] sm:top-[-22px] text-[#191919] font-workSans text-xs sm:text-sm font-bold w-11 text-center"
              >
                70%
              </motion.span>
              <div className="flex justify-between items-end gap-1 sm:gap-1.5 w-full h-[60px] sm:h-[88px] px-1">
                <motion.div initial={{ scaleY: 0 }} whileInView={{ scaleY: 1 }} viewport={{ once: true }} transition={{ duration: 0.6, delay: 0.2, ease: "easeOut" }} style={{ originY: 1 }} className="rounded-t-[4px] opacity-[41%] bg-[#A64AED] w-[14%] h-5"></motion.div>
                <motion.div initial={{ scaleY: 0 }} whileInView={{ scaleY: 1 }} viewport={{ once: true }} transition={{ duration: 0.6, delay: 0.3, ease: "easeOut" }} style={{ originY: 1 }} className="rounded-t-[4px] opacity-[41%] bg-[#A64AED] w-[14%] h-[36px]"></motion.div>
                <motion.div initial={{ scaleY: 0 }} whileInView={{ scaleY: 1 }} viewport={{ once: true }} transition={{ duration: 0.6, delay: 0.4, ease: "easeOut" }} style={{ originY: 1 }} className="rounded-t-[4px] bg-[#DDC6EF] w-[14%] h-[68px]"></motion.div>
                <motion.div initial={{ scaleY: 0 }} whileInView={{ scaleY: 1 }} viewport={{ once: true }} transition={{ duration: 0.6, delay: 0.5, ease: "easeOut" }} style={{ originY: 1 }} className="rounded-t-[4px] opacity-[41%] bg-[#A64AED] w-[14%] h-[52px]"></motion.div>
                <motion.div initial={{ scaleY: 0 }} whileInView={{ scaleY: 1 }} viewport={{ once: true }} transition={{ duration: 0.6, delay: 0.6, ease: "easeOut" }} style={{ originY: 1 }} className="rounded-t-[4px] bg-[#A64AED] w-[14%] h-[88px]"></motion.div>
              </div>
            </div>
          </motion.div>
          ...
          >
            {/* Top row */}
            <div className="flex justify-between items-center w-full">
              <div className="flex items-center justify-center rounded-xl bg-[#A64AED] w-[34px] h-[34px] sm:w-[44px] sm:h-[44px] shrink-0">
                <svg
                  viewBox="0 0 44 44"
                  fill="none"
                  xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="flex flex-col gap-2 sm:gap-3 w-full mt-auto mb-2 px-1 select-none">
              <div className="w-full">
                <div className="h-1.5 sm:h-2 w-full rounded-full bg-[#E2E7FF] overflow-hidden">
                  <motion.div initial={{ width: 0 }} whileInView={{ width: "85%" }} viewport={{ once: true }} transition={{ duration: 1, delay: 0.3, ease: "easeOut" }} className="h-full rounded-full bg-[#A64AED]" />
                </div>
              </div>
              <div className="w-full">
                <div className="h-1.5 sm:h-2 w-full rounded-full bg-[#E2E7FF] overflow-hidden">
                  <motion.div initial={{ width: 0 }} whileInView={{ width: "45%" }} viewport={{ once: true }} transition={{ duration: 1, delay: 0.5, ease: "easeOut" }} className="h-full rounded-full bg-[#F5A623]" />
                </div>
              </div>
            </div>
          </motion.div>
