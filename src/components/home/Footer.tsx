        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 lg:gap-12 mb-8 sm:mb-12">
          ...
          <div className="lg:col-span-3 space-y-4">
            ...
            <div className="space-y-3">
              <a href="mailto:evenacademy.ea@gmail.com" className="flex items-center gap-3 group">
                ...
                <span className="text-[14px] font-medium text-[#6B7280] group-hover:text-[#A64AED] transition-colors break-all">
                  evenacademy.ea@gmail.com
                </span>
              </a>
              <a href="tel:+919667167448" className="flex items-center gap-3 group">
                <div className="text-[#6B7280] group-hover:text-[#A64AED] transition-colors">
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
