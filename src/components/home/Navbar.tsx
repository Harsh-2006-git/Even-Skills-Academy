      ...
      >
        <Link href="/" className="flex items-center">
          <div className="flex flex-col leading-[0.95] font-[900] tracking-tighter">
            <span className="text-[22px] sm:text-[29px] flex items-baseline">
              <span className="text-[#A64AED]">Eve</span>
              <span className="text-[#1A1A1A]">n</span>
            </span>
            <span className="text-[22px] sm:text-[29px] text-[#A64AED]">
              Skills Academy
            </span>
          </div>
        </Link>
        ...
        <div className="flex items-center gap-2 sm:gap-4">
          <Link href="/#contact">
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="flex items-center gap-1.5 sm:gap-3 px-4 py-2 sm:px-7 sm:py-3 bg-[#A64AED] text-white rounded-full font-bold text-[13px] sm:text-base shadow-md hover:bg-[#9333EA] transition-all cursor-pointer"
            >
              <div className="relative w-[20px] h-[20px] sm:w-[28px] sm:h-[28px] bg-white rounded-[4px] sm:rounded-[6px] flex items-center justify-center shadow-sm">
                <svg 
